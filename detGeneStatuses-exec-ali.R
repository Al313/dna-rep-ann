...
# devtools::install_github('git@github.com:UMCUGenetics/geneDriverAnnotator.git')
...
manifest <- manifest[manifest$sample %in% metadata_included$sample_id,]
...
# JAVA <- "/home/ali313/Documents/studies/master/umc-project/hpc/cuppen/projects/P0013_WGS_patterns_Diagn/CUPs_classifier/processed/geneDriverAnnotator/dep/jre1.8.0_191/bin/java"
